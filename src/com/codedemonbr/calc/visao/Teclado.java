...
import com.codedemonbr.calc.modelo.Memoria;
...
public class Teclado extends JPanel implements ActionListener {
	...
	private void adicionarBotao(String label, Color corBotao, GridBagConstraints c, int linha, int coluna) {
		c.gridx = linha;
		c.gridy = coluna;
		Botao botao = new Botao(label, corBotao);
